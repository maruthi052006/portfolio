...
import { Home, User, GraduationCap, Briefcase, FolderKanban, Send, FileText } from "lucide-react";
...
function App() {
  ...
  const dockItems = [
    ...
    { icon: <FileText size={20} />, label: "Resume", onClick: () => window.open("/resume.pdf", "_blank") },
