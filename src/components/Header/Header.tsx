          ...
          <div className="glass-panel w-full max-w-7xl rounded-[2rem] flex items-center justify-between px-6 py-4 shadow-xl">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold glass-panel text-foreground hover:text-primary hover:border-primary/40 transition-all border border-foreground/10 cursor-pointer shadow-sm"
              >
                ...
                >
                  ...
                  <motion.li {...({ variants: itemVariants } as MotionProps)}>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-2xl font-bold text-primary hover:underline flex items-center gap-2 cursor-pointer pt-2"
                    >
