        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 md:gap-24">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-5">
              <a 
                href="mailto:vasanmaruthi466@gmail.com"
                className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group"
              >
                <div className="w-12 h-12 rounded-full glass-panel flex items-center justify-center group-hover:scale-110 group-hover:border-primary/40 transition-all shadow-sm">
                  <Mail className="w-5 h-5 text-primary" />
                </div>
                <span className="font-medium text-foreground group-hover:text-primary transition-colors">vasanmaruthi466@gmail.com</span>
              </a>

              <a 
                href="tel:+918778936806"
                className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group"
              >
                <div className="w-12 h-12 rounded-full glass-panel flex items-center justify-center group-hover:scale-110 group-hover:border-primary/40 transition-all shadow-sm">
                  <Phone className="w-5 h-5 text-emerald-500" />
                </div>
                <span className="font-medium text-foreground group-hover:text-primary transition-colors">+91-8778936806</span>
              </a>

              <div className="flex items-center gap-4 text-muted-foreground group">
                <div className="w-12 h-12 rounded-full glass-panel flex items-center justify-center shadow-sm">
                  <MapPin className="w-5 h-5 text-sky-500" />
                </div>
                <span className="font-medium">Aruppukottai, Virudhunagar, Tamil Nadu</span>
              </div>
            </div>
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                href="https://www.linkedin.com/in/maruthi-vasan-k-64977a2ba"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold glass-panel border border-foreground/10 hover:border-primary/40 text-foreground hover:text-primary transition-all hover:-translate-y-0.5 shadow-sm cursor-pointer"
              >
                <Linkedin className="w-4 h-4 text-[#0077B5]" />
                <span>LinkedIn Profile</span>
              </a>
              <a
                href="https://github.com/maruthi052006"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold glass-panel border border-foreground/10 hover:border-primary/40 text-foreground hover:text-primary transition-all hover:-translate-y-0.5 shadow-sm cursor-pointer"
              >
