...
import { ArrowRight, Download, Eye, Github, Linkedin, Mail, Phone } from "lucide-react";
...
const heroSocialLinks = [
  { icon: Github, href: "https://github.com/maruthi052006", label: "GitHub", external: true },
  { icon: Linkedin, href: "https://www.linkedin.com/in/maruthi-vasan-k-64977a2ba", label: "LinkedIn", external: true },
  { icon: Phone, href: "tel:+918778936806", label: "Call +91-8778936806", external: false },
  { icon: Mail, href: "mailto:vasanmaruthi466@gmail.com", label: "Email vasanmaruthi466@gmail.com", external: false },
];
    ...
    <section id="hero" className="relative min-h-[100vh] flex flex-col pt-12 md:pt-16 overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-1 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 pb-12">
        ...
        >
          ...
          >
            Final-year B.Tech student in AI & Data Science with hands-on experience building full-stack, AI-driven web applications. Passionate about deploying scalable, data-driven solutions.
          </motion.p>

          <motion.div 
            className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-10 w-full md:w-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-full px-6 h-12 glass-panel text-foreground font-semibold gap-2 hover:bg-foreground/10 hover:border-primary/40 transition-all hover:-translate-y-1 border border-foreground/10 text-sm cursor-pointer shadow-sm"
            >
            ...
            <a
              href="/resume.pdf"
              download="Maruthi_Vasan_K_Resume.pdf"
              className="inline-flex items-center justify-center rounded-full px-5 h-12 glass-panel text-muted-foreground hover:text-foreground font-semibold gap-2 hover:bg-foreground/10 hover:border-primary/40 transition-all hover:-translate-y-1 border border-foreground/10 text-sm cursor-pointer shadow-sm"
          ...
          {/* Social Links */}
          <motion.div 
            className="flex items-center gap-3.5 justify-center md:justify-start w-full md:w-auto"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.8, duration: 0.8 }}
          >
            {heroSocialLinks.map(({ icon: Icon, href, label, external }, i) => (
              <a 
                key={i} 
                href={href} 
                ...
                aria-label={label}
                title={label}
                className="w-10 h-10 rounded-full glass-panel border border-foreground/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/40 hover:-translate-y-1 transition-all shadow-sm cursor-pointer"
              >
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="relative px-5 pt-7 pb-6 flex flex-col items-center bg-gradient-to-br from-purple-700 via-primary to-indigo-950 text-white overflow-hidden">
                ...
                <div className="mt-1 relative w-28 h-28 rounded-full p-1 bg-gradient-to-tr from-cyan-400 via-primary to-purple-400 backdrop-blur-md shadow-2xl border border-white/50 overflow-hidden group">
                  <img 
                    src="/image.png" 
                    alt="K. Maruthi Vasan" 
                    className="w-full h-full object-cover object-[center_20%] rounded-full filter contrast-105"
                    loading="eager"
                  />
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">K. Maruthi Vasan</h3>
