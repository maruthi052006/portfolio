  ...
  const education = [
    {
      ...
      details: [
        ...
        "Peer-reviewed conference publication in machine learning",
        "Building full-stack, AI-driven web applications",
        "Active participation in technical symposiums and hackathons"
      ]
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      school: "SBK Higher Secondary School, Aruppukottai",
      year: "2022 – 2023",
      badge: "78.5%",
      badgeIcon: Sparkles,
